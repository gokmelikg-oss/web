...
export default async function AboutPage({ params }: { params: Promise<{ locale: Locale }> }) {
  ...
  return (
    <>
      ...
      <section className="section-pad bg-white">
        <div className="container-page">
          <div className="mx-auto grid grid-cols-1 max-w-5xl gap-6 lg:grid-cols-2">
            <Reveal>
              <div className="flex h-full flex-col rounded-3xl bg-graphite-gradient p-9 text-white sm:p-11">
                ...
                <h2 className="mt-6 font-display type-h2-sm font-bold">Misyonumuz</h2>
            ...
            <Reveal delay={0.08}>
              <div className="flex h-full flex-col rounded-3xl border border-graphite-700/10 bg-mist-50 p-9 sm:p-11">
                ...
                <h2 className="mt-6 font-display type-h2-sm font-bold text-graphite-950">Vizyonumuz</h2>
      ...
      <section className="section-pad bg-mist-900 text-mist-50">
        <div className="container-page">
          <Reveal>
            <h2 className="max-w-lg text-balance font-display type-h2 font-bold tracking-tight">
              {t('values.title')}
            </h2>
          </Reveal>
          <div className="mt-14 grid grid-cols-1 gap-px overflow-hidden rounded-2xl border border-white/10 bg-white/[0.06] sm:grid-cols-3">
            {values.map((item, i) => {
